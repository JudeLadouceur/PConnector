...
public class NodeInfoAttribute : Attribute
{
    ...
    public NodeInfoAttribute(string title, string menuItem = "", bool hasFlowInput = true, bool hasMultipleFlowInputs = false, bool hasFlowOutput = true, bool hasMultipleFlowOutputs = false)
    {
        m_nodeTitle = title;
        m_menuItem = menuItem;
